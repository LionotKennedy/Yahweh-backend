...
router.get('/home-page/:id/with-videos', homePageWithVideosController.getWithVideos);
...
router.get('/home-page/:homePageId/videos', videosByHomePageController.getByHomePageId);
